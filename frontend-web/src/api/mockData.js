...
export const mockDashboardStats = {
  ...
  recentSales: [
    { id: 'W-089', total: 85.50, date: new Date(), paymentMethod: 'cash' },
    { id: 'O-156', total: 120.00, date: new Date(Date.now() - 300000), paymentMethod: 'card' },
    { id: 'W-088', total: 65.75, date: new Date(Date.now() - 600000), paymentMethod: 'mobile' },
  ]
};
...
export const mockUsers = [
  ...
  },
  {
    ...
    role: 'manager',
    status: 'active',
    permissions: ['menu', 'inventory', 'reports'],
...
export const mockOrders = [
  {
    ...
    items: [
      ...
      { id: 'oi2', menuItemId: '4', name: 'Longganisa', price: 15, quantity: 1 }
    ],
    subtotal: 75,
    discount: 0,
    total: 75,
...
export const mockCateringOrders = [
  {
    ...
    status: 'confirmed',
    items: [
      { menuItemId: '11', name: 'Rice + Vegetable + Lumpia', quantity: 25, price: 45 }
    ],
    total: 1125,
